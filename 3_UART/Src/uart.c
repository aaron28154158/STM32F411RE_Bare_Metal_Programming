...
#define MODER_ALTERNATE_MASK	(0x02UL)
#define MODER2_POS				(4)
#define MODER3_POS				(6)
#define MODER2_ALTERNATE_MODE 	MODER_ALTERNATE_MASK << MODER2_POS
#define MODER3_ALTERNATE_MODE 	MODER_ALTERNATE_MASK << MODER3_POS

#define AFR_CLEAR_MASK			(0x0FUL)
#define AFRL_AF07_MASK			(0x07UL)
#define AFRL2_POS				(8)
#define AFRL3_POS				(12)
#define AFRL2_AF07				(AFRL_AF07_MASK << AFRL2_POS)
#define AFRL3_AF07				(AFRL_AF07_MASK << AFRL3_POS)
